      ...
      <div class="col-md-6">
        <form method="post" action="bill.php">
          <div class="form-group">
            ...
            <input type="number" max="50" min="2" class="form-control" id="tableNumber" name="tableNumber" required>
          </div>
          ...
          <button type="submit" class="btn btn-primary" name="table" onclick="return submitForm()">Submit</button>
        </form>
      </div>
    </div>
  </div>
